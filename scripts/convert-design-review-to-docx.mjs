...
const mdPath = join(__dirname, '..', 'PRODUCT_STRATEGY_COACH_DESIGN_REVIEW.md');
...
// Write to file
const outputPath = join(__dirname, '..', 'PRODUCT_STRATEGY_COACH_DESIGN_REVIEW.docx');

Packer.toBuffer(doc).then((buffer) => {
  writeFileSync(outputPath, buffer);
  console.log('✓ Design Review document created successfully:', outputPath);
