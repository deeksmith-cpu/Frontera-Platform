...
const mdPath = join(__dirname, '..', 'MOCKUPS_PRIORITY_1_STREAMING_AND_TERRITORY_NAV.md');
...
// Write to file
const outputPath = join(__dirname, '..', 'MOCKUPS_PRIORITY_1_STREAMING_AND_TERRITORY_NAV.docx');
