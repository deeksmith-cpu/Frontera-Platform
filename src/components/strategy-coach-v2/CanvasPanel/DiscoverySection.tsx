    ...
    <section className="discovery-section mb-16">
      <div className="section-header mb-8">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 rounded-full bg-[#1a1f3a]/10 flex items-center justify-center text-[#1a1f3a] font-bold text-sm">
            1
          </div>
          <h3 className="text-3xl font-bold text-slate-900">Discovery</h3>
          <span className="text-xs font-bold uppercase tracking-wider text-[#fbbf24] bg-[#fbbf24]/10 px-3 py-1.5 rounded-full">
            Context Setting
          </span>
        </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="group bg-white border border-slate-100 rounded-2xl p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-[#fbbf24]/40">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-14 h-14 rounded-xl bg-[#1a1f3a]/10 flex items-center justify-center text-[#1a1f3a] flex-shrink-0 transition-transform duration-300 group-hover:scale-110">
          ...
          <div className="space-y-5">
            ...
            {hasContext && (
              <div className="space-y-4">
                <div className="text-xs font-semibold uppercase tracking-wider text-[#fbbf24] mb-3">
        ...
        <div
          className={`group relative bg-white border-2 border-dashed rounded-2xl p-8 transition-all duration-300 ${
            isDragOver
              ? 'border-[#fbbf24] bg-[#fbbf24]/10 shadow-xl scale-105'
              : 'border-slate-200 hover:border-[#fbbf24] hover:bg-slate-50'
          }`}
        ...
        >
          <div className="flex flex-col items-center justify-center text-center h-full">
            <div className="w-14 h-14 rounded-xl bg-[#fbbf24]/10 flex items-center justify-center text-[#fbbf24] mb-5 transition-transform duration-300 group-hover:scale-110">
            ...
            <div className="flex flex-col gap-3 w-full max-w-xs">
              <label className="relative cursor-pointer">
                ...
                />
                <div className="flex items-center justify-center gap-2 px-5 py-2.5 bg-[#fbbf24] text-slate-900 rounded-xl hover:bg-[#f59e0b] hover:shadow-lg hover:scale-105 transition-all duration-300 font-semibold text-sm">
              ...
              <button className="flex items-center justify-center gap-2 px-5 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-xl hover:border-[#fbbf24] hover:bg-slate-50 hover:shadow-md transition-all duration-300 font-semibold text-sm">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
