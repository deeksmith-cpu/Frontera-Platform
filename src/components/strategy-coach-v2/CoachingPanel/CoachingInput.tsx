    ...
    <div className="coaching-input p-6 border-t border-slate-100 bg-white">
      <div className="input-wrapper relative">
        ...
        <button
          ...
          className="send-btn absolute right-2 bottom-2 w-10 h-10 bg-[#fbbf24] border-0 rounded-xl flex items-center justify-center text-slate-900 hover:bg-[#f59e0b] cursor-pointer transition-all hover:shadow-lg hover:scale-105 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none"
        >
