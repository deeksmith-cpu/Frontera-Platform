      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-12 max-w-lg">
          <div className="rounded-2xl bg-white/10 backdrop-blur-sm p-8 text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#06b6d4] to-[#22d3ee] mb-6">
            ...
            <Link
              href="/onboarding"
              className="inline-flex items-center justify-center gap-2 w-full rounded-full bg-[#06b6d4] py-4 text-base font-semibold text-white shadow-lg shadow-[#06b6d4]/25 transition-all duration-200 hover:bg-[#22d3ee] hover:shadow-xl"
            >
              Get in Contact
