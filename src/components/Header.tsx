          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end lg:items-center lg:gap-x-4">
            ...
            {isSignedIn && (
              <>
                <Link
                  href="/dashboard"
                  className="inline-flex items-center justify-center rounded-lg border border-white/20 px-5 py-2 text-sm font-semibold text-white transition-all duration-300 hover:bg-white/10 hover:border-white/40 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#fbbf24] focus:ring-offset-2 focus:ring-offset-[#1a1f3a] active:bg-[#fbbf24] active:text-slate-900 active:border-[#fbbf24]"
                >
                  Dashboard
                </Link>
                <Link
