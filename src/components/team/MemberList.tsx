      ...
      <div className="flex items-center justify-between">
        ...
        {isAdmin && (
          <button
            ...
            className="px-5 py-2.5 rounded-xl font-semibold bg-[#1a1f3a] text-white hover:bg-[#2d3561] shadow-lg shadow-[#1a1f3a]/25 transition-all flex items-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
      ...
      {members.length === 0 && (
        <div className="text-center py-12">
          ...
          {isAdmin && (
            <button
              onClick={handleInvite}
              className="px-6 py-3 rounded-xl font-semibold bg-[#1a1f3a] text-white hover:bg-[#2d3561] shadow-lg shadow-[#1a1f3a]/25 transition-all"
            >
