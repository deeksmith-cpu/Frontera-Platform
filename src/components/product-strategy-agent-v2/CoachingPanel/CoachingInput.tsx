        ...
        <div className="flex gap-1.5 mb-2 overflow-x-auto pb-0.5">
          {[
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-[11px] px-2.5 py-1 bg-white hover:bg-slate-50 text-slate-500 hover:text-slate-700 rounded-lg border border-slate-200 hover:border-slate-300 transition-colors whitespace-nowrap flex-shrink-0"
            >
