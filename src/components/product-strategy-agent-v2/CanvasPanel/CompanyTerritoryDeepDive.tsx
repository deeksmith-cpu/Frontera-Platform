...
// Company Territory Research Areas (v3.0: 3 areas × 3 questions = 9 questions)
const RESEARCH_AREAS = [
  {
    ...
    questions: [
      'What are your organization\'s core competencies and differentiating capabilities? Which are table stakes vs. truly differentiated?',
  ...
  },
  {
    ...
    description: 'What team, funding, and talent realities will enable or constrain your strategy execution?',
    questions: [
