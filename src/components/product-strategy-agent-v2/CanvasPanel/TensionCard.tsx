                ...
                {tension.resolutionOptions.map((option, idx) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      {option.recommended && (
                        <div className="w-6 h-6 rounded-full bg-[#1a1f3a] flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          {option.recommended && (
                            <span className="text-xs font-semibold text-[#1a1f3a] uppercase tracking-wider">
                              Recommended
                            </span>
                          )}
                        </div>
