    ...
    <section id="testimonial" className="bg-white py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <p className="text-sm font-semibold uppercase tracking-wider text-[#fbbf24]">Case Study</p>
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-slate-50 to-slate-100 p-8 lg:p-12">
            {/* Quote mark */}
            <div className="absolute -top-4 left-10 text-8xl font-serif text-[#fbbf24]/20">&ldquo;</div>

            <div className="relative">
              {/* Company logo placeholder */}
              <div className="mb-8 flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-[#1a1f3a] text-white font-bold text-xl">
                  A
                </div>
                <div>
              ...
              <blockquote className="text-xl leading-relaxed text-slate-700 lg:text-2xl lg:leading-relaxed">
                ...
                <span className="font-semibold text-[#1a1f3a]">translate strategy into action, and outcomes into culture</span>.
                We now coach capability, not compliance.&rdquo;
              </blockquote>

              {/* Attribution */}
              <div className="mt-8 flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-gradient-to-br from-[#1a1f3a] to-[#fbbf24]" />
                <div>
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 lg:grid-cols-4">
            <div className="rounded-2xl bg-slate-50 p-6 text-center">
              <div className="text-3xl font-bold text-[#1a1f3a]">6 mo</div>
              <div className="mt-1 text-sm text-slate-600">Time to Value</div>
            </div>
            <div className="rounded-2xl bg-slate-50 p-6 text-center">
              <div className="text-3xl font-bold text-[#1a1f3a]">Company-wide</div>
              <div className="mt-1 text-sm text-slate-600">Product Strategy Launched</div>
            </div>
            <div className="rounded-2xl bg-slate-50 p-6 text-center">
              <div className="text-3xl font-bold text-[#1a1f3a]">North Star</div>
              <div className="mt-1 text-sm text-slate-600">Metrics Across Verticals</div>
            </div>
            <div className="rounded-2xl bg-slate-50 p-6 text-center">
              <div className="text-3xl font-bold text-[#1a1f3a]">OKR</div>
          ...
          <div className="mt-12 rounded-2xl border border-slate-200 bg-white p-8">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg className="h-5 w-5 shrink-0 text-[#fbbf24] mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
