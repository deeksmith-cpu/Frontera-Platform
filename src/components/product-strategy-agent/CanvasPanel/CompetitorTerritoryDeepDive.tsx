...
export function CompetitorTerritoryDeepDive({
  ...
  return (
    <div className="competitor-territory-deep-dive flex flex-col md:flex-row h-full">
      {/* Sidebar (25% width) */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 bg-gradient-to-br from-[#0891b2] to-[#0e7490] rounded-2xl flex items-center justify-center shadow-lg">
                ...
                <div key={index} className="question-card bg-white rounded-2xl border-2 border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                  <label className="block">
                    <div className="flex items-start gap-3 mb-4">
                      <span className="inline-flex items-center justify-center w-8 h-8 bg-cyan-50 text-[#0891b2] rounded-lg text-sm font-bold flex-shrink-0">
                        {index + 1}
                      </span>
            ...
            <div className="bg-white rounded-2xl border-2 border-slate-200 p-6 shadow-lg">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-cyan-50 to-[#ecfeff] border-2 border-cyan-200 text-[#0891b2] rounded-xl font-bold hover:border-cyan-400 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                ...
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gradient-to-r from-[#0891b2] to-[#0e7490] text-white rounded-xl font-bold hover:shadow-xl hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 transition-all shadow-lg"
                >
