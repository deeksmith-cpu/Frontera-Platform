...
/**
 * TerritorialInsightSummary — Displays 3 key findings from micro-synthesis
 * after a territory reaches full mapping (3/3 research areas).
 *
 * Shown above territory cards in ResearchSection overview.
 */
export function TerritorialInsightSummary({
  ...
  return (
    <div className="bg-white border-2 border-cyan-200 rounded-2xl overflow-hidden shadow-md animate-entrance">
      {/* Header */}
