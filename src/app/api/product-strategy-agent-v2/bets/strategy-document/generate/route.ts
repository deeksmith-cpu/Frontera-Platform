...
// POST /api/product-strategy-agent-v2/bets/strategy-document/generate
...
Be specific, actionable, and grounded in the company's context. Return ONLY the JSON object.`;
    ...
    console.error('POST /api/product-strategy-agent-v2/bets/strategy-document/generate:', error);
