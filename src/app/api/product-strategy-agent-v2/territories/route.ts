...
// GET /api/product-strategy-agent-v2/territories?conversation_id=xxx
...
// POST /api/product-strategy-agent-v2/territories
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { conversation_id, territory, research_area, responses, status, confidence } = body;
