...
/**
 * GET /api/product-strategy-agent/signals
...
/**
 * POST /api/product-strategy-agent/signals
...
/**
 * PATCH /api/product-strategy-agent/signals
 * Update a signal.
 */
...
/**
 * DELETE /api/product-strategy-agent/signals
 * Delete a signal.
 */
