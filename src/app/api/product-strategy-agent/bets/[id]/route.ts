...
// PATCH /api/product-strategy-agent/bets/[id] - Update bet
export async function PATCH(
  ...
  try {
    ...
    console.error('PATCH /api/product-strategy-agent/bets/[id]:', error);
...
// DELETE /api/product-strategy-agent/bets/[id] - Delete bet
export async function DELETE(
  ...
  try {
    ...
    console.error('DELETE /api/product-strategy-agent/bets/[id]:', error);
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    );
