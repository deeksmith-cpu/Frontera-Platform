...
/**
 * GET /api/product-strategy-agent/versions
...
/**
 * POST /api/product-strategy-agent/versions
...
export async function POST(req: NextRequest) {
  ...
  const snapshot = {
    ...
    synthesis: synthesis
      ? {
          executive_summary: (synthesis as Record<string, unknown>).executive_summary,
          opportunities: (synthesis as Record<string, unknown>).opportunities,
          tensions: (synthesis as Record<string, unknown>).tensions,
        }
      : null,
