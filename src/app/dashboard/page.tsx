    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-cyan-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-2xl border border-[#1a1f3a]/20 bg-[#ecfeff] p-6 transition-all duration-300 hover:shadow-lg hover:border-[#1a1f3a]/40">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-bold text-[#1a1f3a]">Product Strategy Development</h3>
                </div>
          ...
          <a href="/dashboard/product-strategy-agent-v2" className="block">
            <div className="rounded-2xl border border-[#1a1f3a]/20 bg-[#ecfeff] p-6 transition-all duration-300 hover:shadow-lg hover:border-[#1a1f3a]/40">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="px-2.5 py-1 bg-[#fbbf24] text-slate-900 text-xs font-bold rounded-full uppercase tracking-wide">MVP 2.0</span>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
                Enhanced version based on user feedback — guided research, analysis and expert coaching.
              </p>
              <div className="inline-flex items-center gap-2 rounded-lg bg-[#1a1f3a] px-4 py-2 text-sm font-semibold text-white hover:bg-[#2d3561] transition-colors">
                Open Strategy Coach v2
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </div>
          ...
          <Link href="/dashboard/leadership-playbook" className="block">
            <div className="rounded-2xl border border-[#1a1f3a]/20 bg-[#ecfeff] p-6 transition-all duration-300 hover:shadow-lg hover:border-[#1a1f3a]/40">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-[#1a1f3a]">Leadership Playbook</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
          ...
          <div className="rounded-2xl border border-[#1a1f3a]/10 bg-[#ecfeff]/60 p-6">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-10 h-10 rounded-xl bg-[#2d3561]/40 flex items-center justify-center">
                <svg className="w-5 h-5 text-[#fbbf24]/50" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-[#1a1f3a]/40">Documents</h3>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed mb-4">
              View and manage your strategic outputs, frameworks, and insights.
            </p>
            <div className="inline-flex items-center gap-2 rounded-lg bg-[#1a1f3a]/10 px-4 py-2 text-sm font-semibold text-slate-400">
          ...
          <Link href="/dashboard/team" className="block">
            <div className="rounded-2xl border border-[#1a1f3a]/20 bg-[#ecfeff] p-6 transition-all duration-300 hover:shadow-lg hover:border-[#1a1f3a]/40">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="text-lg font-bold text-[#1a1f3a]">Team</h3>
              </div>
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
            ...
            <Link href="/dashboard/admin" className="block lg:col-span-2">
              <div className="rounded-2xl border border-[#1a1f3a]/20 bg-[#ecfeff] p-6 transition-all duration-300 hover:shadow-lg hover:border-[#1a1f3a]/40">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#1a1f3a]">Admin Panel</h3>
                    <span className="text-xs text-[#fbbf24] font-semibold">Frontera Administrator</span>
                  </div>
                </div>
                <p className="text-sm text-slate-600 leading-relaxed mb-4">
