    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      <div className="sticky top-0 z-50 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3 lg:hidden">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded bg-[#1a1f3a] text-white font-bold">
            F
          </div>
        ...
        <aside
          ...
          <div className="flex h-full flex-col p-6">
            <div className="mb-8 hidden lg:flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#1a1f3a] text-white font-bold text-xl">
                F<span className="text-[#ff6b35]">›</span>
              </div>
              <div>
